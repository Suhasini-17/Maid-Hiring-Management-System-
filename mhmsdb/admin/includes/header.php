...
{               ?>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="images/layout_img/user_image.png" alt="#" /><span class="name_user"><?php  echo $row->AdminName;?></span></a><?php $cnt=$cnt+1;}} ?>
